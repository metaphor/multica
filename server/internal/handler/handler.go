...
type Handler struct {
	...
	// GitLabBox is the at-rest encryption key for GitLab personal access tokens
	// and webhook secrets. Nil when MULTICA_GITLAB_SECRET_KEY is unset; the
	// GitLab connection handlers return 503 in that case.
